  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-4xl mx-auto pt-24 px-4 pb-20">
        <h1 className="text-3xl font-bold mb-8">About My Journal</h1>
        
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Our Mission</h2>
          <p className="text-gray-300 mb-6">
            My Journal is a personal journaling app designed to help you document your thoughts, ideas, and memories in a secure and private environment. 
          ...
          <p className="text-gray-300">
            My Journal was created by a team of developers who are passionate about personal development and mental wellbeing. 
